...
const AboutSection = () => {
  ...
  return (
    <section className="text-black dark:text-whitedark:bg-gradient-to-r dark:from-[#141330] dark:to-[#57618c] bg-gradient-to-r from-[#818bb6] via-[#82b2c1] to-[#aabec6]">
      <div className="md:grid  min-h-[700px] md:grid-cols-2 gap-8 items-center py-8 px-6 lg:px-0 xl:gap-16 sm:py-16 lg:max-w-6xl mx-auto">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <div className="mt-4 border border-slate-700 dark:border-gray-100 rounded-md p-4">
