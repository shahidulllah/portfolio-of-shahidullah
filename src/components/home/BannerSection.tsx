...
function BannerSection() {
  return (
    <section className="relative lg:py-32 py-24 px-6 bg-gradient-to-r from-slate-400 to-slate-700 dark:bg-gradient-to-r dark:from-[#2d2a44] dark:via-[#35365c] dark:to-[#32445b] text-black dark:text-white overflow-hidden">
